...
void Parameters::initDefault()
{
    ...
    /* Flight start */
    P_FLIGHT_START_VARIO_LOW_THRESHOLD = new ConfigParameter<float>(PARAM_FLIGHT_START_VARIO_LOW_THRESHOLD, DEFAULT_FLIGHT_START_VARIO_LOW_THRESHOLD);
    P_FLIGHT_START_VARIO_HIGH_THRESHOLD = new ConfigParameter<float>(PARAM_FLIGHT_START_VARIO_HIGH_THRESHOLD, DEFAULT_FLIGHT_START_VARIO_HIGH_THRESHOLD);
    P_FLIGHT_START_MIN_SPEED = new ConfigParameter<float>(PARAM_FLIGHT_START_MIN_SPEED, DEFAULT_FLIGHT_START_MIN_SPEED);
    P_RECORD_WHEN_FLIGHT_START = new ConfigParameter<bool>(PARAM_RECORD_WHEN_FLIGHT_START, DEFAULT_RECORD_WHEN_FLIGHT_START);
    ...
    VARIO_PARAM_DEBUG_PRINT(P_BT_ENABLE->getKey());
    VARIO_PARAM_DEBUG_PRINTLN(P_BT_ENABLE->getValue());

    VARIO_PARAM_DEBUG_PRINT(P_NO_RECORD->getKey());
    VARIO_PARAM_DEBUG_PRINTLN(P_NO_RECORD->getValue());

    VARIO_PARAM_DEBUG_PRINT(P_BEEP_GPSFIX->getKey());
    VARIO_PARAM_DEBUG_PRINTLN(P_BEEP_GPSFIX->getValue());

    VARIO_PARAM_DEBUG_PRINT(P_BEEP_FLYBEGIN->getKey());
    VARIO_PARAM_DEBUG_PRINTLN(P_BEEP_FLYBEGIN->getValue());

    VARIO_PARAM_DEBUG_PRINT(P_BEEP_VARIOBEGIN->getKey());
    VARIO_PARAM_DEBUG_PRINTLN(P_BEEP_VARIOBEGIN->getValue());

    VARIO_PARAM_DEBUG_PRINT(P_MUTE_VARIOBEGIN->getKey());
    VARIO_PARAM_DEBUG_PRINTLN(P_MUTE_VARIOBEGIN->getValue());

    VARIO_PARAM_DEBUG_PRINT(P_SLEEP_TIMEOUT_MINUTES->getKey());
    VARIO_PARAM_DEBUG_PRINTLN(P_SLEEP_TIMEOUT_MINUTES->getValue());

    VARIO_PARAM_DEBUG_PRINT(P_SLEEP_THRESHOLD_CPS->getKey());
    VARIO_PARAM_DEBUG_PRINTLN(P_SLEEP_THRESHOLD_CPS->getValue());

    VARIO_PARAM_DEBUG_PRINT(P_MULTIDISPLAY_DURATION->getKey());
    VARIO_PARAM_DEBUG_PRINTLN(P_MULTIDISPLAY_DURATION->getValue());

    VARIO_PARAM_DEBUG_PRINT(P_DISPLAY_STAT_DURATION->getKey());
    VARIO_PARAM_DEBUG_PRINTLN(P_DISPLAY_STAT_DURATION->getValue());

    VARIO_PARAM_DEBUG_PRINT(P_URL_UPDATE->getKey());
    VARIO_PARAM_DEBUG_PRINTLN(P_URL_UPDATE->getValue());

    VARIO_PARAM_DEBUG_PRINT(P_LANGUAGE->getKey());
    VARIO_PARAM_DEBUG_PRINTLN(P_LANGUAGE->getValue());
}