...
class CircleWidget : public TextWidget
{
private:
    char localText[20];
    uint8_t blinkFreq = 0;
...
public:
    CircleWidget(VarioLanguage *_variolanguage, uint8_t altWidgetIndex, int16_t topx, int16_t topy, int16_t width, int16_t height) : TextWidget(_variolanguage, altWidgetIndex, topx, topy, width, height)
    {
