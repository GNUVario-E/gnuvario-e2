...
VarioScreen::VarioScreen(ScreenData data, VarioLanguage *_varioLanguage)
{
    ...
    logoWidget->setVarioLangage(_varioLanguage);
    ...
    textWidget1->setVarioLangage(_varioLanguage);
    ...
    textWidget2->setVarioLangage(_varioLanguage);
    ...
    textWidget3->setVarioLangage(_varioLanguage);
    ...
    textWidget4->setVarioLangage(_varioLanguage);
    ...
    textWidget5->setVarioLangage(_varioLanguage);
    ...
    textWidget6->setVarioLangage(_varioLanguage);
    ...
    textWidget7->setVarioLangage(_varioLanguage);
    ...
    textWidget8->setVarioLangage(_varioLanguage);
    ...
    altWidget->setVarioLangage(_varioLanguage);
    ...
    varioWidget->setVarioLangage(_varioLanguage);
    ...
    toolbarWidget->setVarioLangage(_varioLanguage);
