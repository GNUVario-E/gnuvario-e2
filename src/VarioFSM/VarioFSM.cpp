...
void VarioFSM::initfsm(VarioDisplay *_varioDisplay)
{
    ...
    fsm.add_timed_transition(&_state_statistic_init, &_state_vario1, params->P_DISPLAY_STAT_DURATION->getValue() * 1000, nullptr); // bascule en mode vario apres les stats initiales
